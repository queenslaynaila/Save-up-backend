...
BEGIN
  ...
  INTO v_transaction_out_type_id, v_transaction_in_type_id;

  IF v_transaction_out_type_id IS NULL OR v_transaction_in_type_id IS NULL THEN
    RAISE EXCEPTION USING 
...
GRANT EXECUTE ON FUNCTION create_transfer(INT, INT, INT, NUMERIC(30, 2), INT) TO saveup_www;

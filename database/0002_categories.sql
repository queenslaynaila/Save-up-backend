...
VALUES ('Food', 'All food related expenses'),
       ...
       ('Default Category', 'A flexible space where you can save money without assigning it to specific purposes right away. Funds saved here are readily available for future use and can be easily allocated to other pockets whenever you choose.');

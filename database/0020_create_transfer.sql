...
GRANT EXECUTE ON FUNCTION log_transfer_transaction(INT, INT, NUMERIC, INT, INT) TO app_user;
SELECT create_distributed_function(
  'log_transfer_transaction(INT, INT, NUMERIC, INT, INT)', 'p_source_pocket_id'
);

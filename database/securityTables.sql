...
GRANT INSERT, SELECT ON security_answers TO app_user; -- Selecting answers to verify questions on pin reset
                                                      -- Creating answers 
CREATE INDEX idx_security_answers_by_user ON security_answers(user_id); 
...
GRANT INSERT, UPDATE ON reset_tokens TO app_user;  -- On initiating a pin reset inserting the generated token to db
                                                   --After verifying token updating on the db thats been used
